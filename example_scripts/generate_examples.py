...
class DatasetGenerator:
    ...
    def silhouette_2d_dataset(
        ...
        dataset = Dataset2D(
            aircraft_types=self.aircraft_types, num_samples=num_samples, image_size=(224, 224)
        )
...
Examples:
  ...
  python generate_examples.py --mode all --obb    # All dataset types with OBBs
    ...
    parser.add_argument(
        "--scenes", type=int, default=50, help="Number of scenes for 3D datasets (default: 50)"
    )

    parser.add_argument(
        "--samples", type=int, default=300, help="Number of samples for 2D datasets (default: 300)"
    )
